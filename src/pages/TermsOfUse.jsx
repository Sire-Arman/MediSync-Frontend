      ...
      <div className="container py-12 md:py-16">
        <div className="privacy-policy mx-auto max-w-4xl">
          <div>
            <h3>Introduction</h3>
            <p>
              Welcome to MediSync! These Terms of Use govern your use of our
          ...
          <div>
            ...
            <p>
              ...
              software, is the property of MediSync or its licensors and is
          ...
          <div>
            ...
            <p>
              To the fullest extent permitted by law, MediSync shall not be
          ...
          <div>
            ...
            <p>
              You agree to indemnify and hold harmless MediSync, its
          ...
          <div>
            ...
            <p>
              Email:{" "}
              <a href="mailto:armansid6783@gmail.com">armansid6783@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
